...
public class BodyDynamicStateFrament extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.main_dynamic_state_fragment, container, false);
		headImageImageView = (ImageView) view.findViewById(R.id.dynamic_state_head_image);
